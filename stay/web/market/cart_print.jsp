...
<head>
    ...
    <link rel=File-List href="新建%20Microsoft%20Word%20文档%20(2).files/filelist.xml">
    <!--[if gte mso 9]><xml>
    <o:DocumentProperties>
        <o:Author>1 1</o:Author>
        <o:LastAuthor>1 1</o:LastAuthor>
        <o:Revision>2</o:Revision>
        <o:TotalTime>4</o:TotalTime>
        <o:Created>2023-10-15T10:25:00Z</o:Created>
        <o:LastSaved>2023-10-15T10:25:00Z</o:LastSaved>
        <o:Pages>1</o:Pages>
        <o:Words>2</o:Words>
    ...
    <link rel=themeData href="新建%20Microsoft%20Word%20文档%20(2).files/themedata.thmx">
    <link rel=colorSchemeMapping
          href="新建%20Microsoft%20Word%20文档%20(2).files/colorschememapping.xml">
    <!--[if gte mso 9]><xml>
 <w:WordDocument>
...
<div class=WordSection1 style='layout-grid:15.6pt'>
 ...
 mso-padding-alt:0cm 5.4pt 0cm 5.4pt'>
            ...
            <tr style='mso-yfti-irow:-1;mso-yfti-firstrow:yes;mso-yfti-lastfirstrow:yes'>
                <td width=184 valign=top style='width:138.25pt;border:solid #4472C4 1.0pt;
  ...
  mso-themecolor:background1'>商品ID<span lang=EN-US><o:p></o:p></span></span></b></p>
                </td>
                <td width=184 valign=top style='width:138.25pt;border-top:solid #4472C4 1.0pt;
  ...
  mso-background-themecolor:accent1;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='mso-yfti-cnfc:1'><b><span lang=EN-US
                                                                        style='color:white;mso-themecolor:background1'><o:p>商品名称</o:p></span></b></p>
                </td>
                <td width=184 valign=top style='width:138.3pt;border:solid #4472C4 1.0pt;
  ...
  accent1;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='mso-yfti-cnfc:1'><b><span lang=EN-US
                                                                        style='color:white;mso-themecolor:background1'><o:p>购物车中的数量</o:p></span></b></p>
                </td>
            </tr>
            </thead>

            <tbody name="line_word" id="line_word">
            <tr style='mso-yfti-irow:0'>
                <td width=184 valign=top style='width:138.25pt;border:solid #8EAADB 1.0pt;
  ...
  accent1;mso-background-themetint:51;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='mso-yfti-cnfc:68'><b><span lang=EN-US><o:p>&nbsp;</o:p></span></b></p>
                </td>
...
<script>
    var initDevicePrintWrodRecord=function()
    {
        ...
        $.post('<%=Config.getInstance().getString("default.urlheader")%>/getCartGood',{"action":"query"},function(json){
            ...
            if(json.code==0){
                var list=json.good_list;
                if(list!=undefined && list.length>0){
                    for(var i=0;i<list.length;i++){
                        var record=list[i];
                        html=html+"<tr style='mso-yfti-irow:0'>;";
                        html=html+"               <td width=184 valign=top style='width:138.25pt;border:solid #8EAADB 1.0pt;";
                        html=html+"  mso-border-themecolor:accent1;mso-border-themetint:153;border-top:none;";
                        html=html+"  mso-border-top-alt:solid #8EAADB .5pt;mso-border-top-themecolor:accent1;";
                        html=html+"  mso-border-top-themetint:153;mso-border-alt:solid #8EAADB .5pt;mso-border-themecolor:";
                        html=html+"  accent1;mso-border-themetint:153;background:#D9E2F3;mso-background-themecolor:";
                        html=html+"  accent1;mso-background-themetint:51;padding:0cm 5.4pt 0cm 5.4pt'>";
                        html=html+"                    <p class=MsoNormal style='mso-yfti-cnfc:68'><b><span lang=EN-US><o:p>"+record.good_id+"</o:p></span></b></p>";
                        html=html+"                </td>";
                        html=html+"                <td width=184 valign=top style='width:138.25pt;border-top:none;border-left:";
                        html=html+"  none;border-bottom:solid #8EAADB 1.0pt;mso-border-bottom-themecolor:accent1;";
                        html=html+"  mso-border-bottom-themetint:153;border-right:solid #8EAADB 1.0pt;mso-border-right-themecolor:";
                        html=html+"  accent1;mso-border-right-themetint:153;mso-border-top-alt:solid #8EAADB .5pt;";
                        html=html+"  mso-border-top-themecolor:accent1;mso-border-top-themetint:153;mso-border-left-alt:";
                        html=html+"  solid #8EAADB .5pt;mso-border-left-themecolor:accent1;mso-border-left-themetint:";
                        html=html+"  153;mso-border-alt:solid #8EAADB .5pt;mso-border-themecolor:accent1;";
                        html=html+"  mso-border-themetint:153;background:#D9E2F3;mso-background-themecolor:accent1;";
                        html=html+"  mso-background-themetint:51;padding:0cm 5.4pt 0cm 5.4pt'>";
                        html=html+"                    <p class=MsoNormal style='mso-yfti-cnfc:64'><span lang=EN-US><o:p>"+record.good_name+"</o:p></span></p>";
                        html=html+"                </td>";
                        html=html+"                <td width=184 valign=top style='width:138.3pt;border-top:none;border-left:";
                        html=html+"  none;border-bottom:solid #8EAADB 1.0pt;mso-border-bottom-themecolor:accent1;";
                        html=html+"  mso-border-bottom-themetint:153;border-right:solid #8EAADB 1.0pt;mso-border-right-themecolor:";
                        html=html+"  accent1;mso-border-right-themetint:153;mso-border-top-alt:solid #8EAADB .5pt;";
                        html=html+" mso-border-top-themecolor:accent1;mso-border-top-themetint:153;mso-border-left-alt:";
                        ...
                        html=html+"  mso-border-themetint:153;background:#D9E2F3;mso-background-themecolor:accent1;";
                        html=html+"  mso-background-themetint:51;padding:0cm 5.4pt 0cm 5.4pt'>";
                        html=html+"                    <p class=MsoNormal style='mso-yfti-cnfc:64'><span lang=EN-US><o:p>"+record.num+"</o:p></span></p>";
                        html=html+"                </td>";
                        html=html+"            </tr>";
                    }
