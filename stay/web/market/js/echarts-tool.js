...
function wbzl() {
    ...
    $.post('/getDriveData',data,function (json) {
        ...
        option = {
            title: {
                text: '',
                textStyle: {fontSize: 18, fontWeight: 600, fontFamily: 'siyuanheiti_Thin'},
                subtext: '',
            ...
            visualMap: {
                show: false,
                max: 20,
                inRange: {color: ['#FF4500', '#FF6347', '#CD5C5C', '#B22222', '#CD5C5C', '#F08080', '#FA8072']}
            },
            xAxis3D: {name: '', type: 'category', data: hours},
            yAxis3D: {name: '', type: 'category', data: days},
            ...
            grid3D: {
                ...
                light: {main: {intensity: 1.2, shadow: true}, ambient: {intensity: 0.7, shadow: true}},
                viewControl: {
                    alpha: 15,
                    beta: 40,
                    autoRotate: true,
...
function yqbj() {
    ...
    var cost_house;
    $.post('/getDriveData',data,function (json) {
        cost_house=json.cost_house;
        cost_specialty=json.cost_specialty;
        ...
        option = {
            ...
            series: [{
                ...
                data: [[0, 0, cost_house], [1, 0, cost_specialty], [2, 0, cost_house+cost_specialty],],
                stack: 'stack',
                shading: 'lambert',
...
function test() {
    ...
    var plantCap = [{name: '工业', value: '222'}, {name: '农业', value: '115'}, {name: '互联网', value: '113'}, {
        name: '医疗',
        value: '95'
    }, {name: '文学', value: '92'}, {name: '服装', value: '87'}];
...
function dbj() {
    ...
    option = {
        ...
        series: [{
            ...
            splitNumber: 8,
            radius: '60%',
            axisLine: {lineStyle: {color: [[0.2, '#7CFC00'], [0.8, '#00FFFF'], [1, '#FF0000']], width: 6}},
            axisTick: {length: 15, lineStyle: {color: 'auto'}},
            splitLine: {length: 20, lineStyle: {color: 'auto'}},
            pointer: {width: 4},
            title: {textStyle: {fontWeight: 'normal', color: '#fff', fontSize: 12,}},
            detail: {textStyle: {fontWeight: 'normal', fontSize: 12}},
            data: [{value: 4, name: ''}]
        }, {
            name: '',
            ...
            endAngle: 0,
            splitNumber: 2,
            axisLine: {lineStyle: {color: [[0.2, '#7CFC00'], [0.8, '#00FFFF'], [1, '#FF0000']], width: 4}},
            axisTick: {length: 12, lineStyle: {color: 'auto'}},
            splitLine: {length: 20, lineStyle: {color: 'auto'}},
            pointer: {width: 3},
            title: {offsetCenter: ['5%', '-20%'], color: '#fff', fontSize: 12,},
            detail: {textStyle: {fontSize: 12, fontWeight: 'normal'}},
            data: [{value: 270, name: ''}]
        }, {
            name: '',
            type: 'gauge',
            ...
            pointer: {width: 2},
            title: {offsetCenter: ['5%', '35%'], color: '#fff', fontSize: 12,},
            detail: {show: false},
            data: [{value: 270, name: ''}]
        }]
    };
