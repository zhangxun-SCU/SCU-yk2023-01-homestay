                        ...
                        <form class="form-horizontal" role="form">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="输入待查找订单编号" id="good_id"
                                               name="good_id">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="输入待查找民宿名称" id="house_name"
                                               name="house_name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="输入待查找房间名称" id="room_name"
                                               name="room_name">
                                    </div>
                                </div>
                            </div>
