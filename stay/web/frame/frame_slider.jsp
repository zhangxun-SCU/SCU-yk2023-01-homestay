...
<%--            商品管理--%>
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="../user/user-profile.jsp">民宿/房源</a></li>
                    <li><a href="./post-details.html">特产</a></li>
...
<%--            订单管理--%>
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="./chart-flot.html">全部</a></li>
                    <li><a href="./chart-morris.html">待付款</a></li>
                    <li><a href="./chart-chartist.html">已完成</a></li>
