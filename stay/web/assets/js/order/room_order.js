...
//     };
//
// >>>>>>> 19e44b36ae37e71a03d8a48c514e9c172ae02829
//     /*----------------------------------------入口函数  结束----------------------------------------*/
...
//         $('#order_list_all_button').click(function() {onOrderListAll();});
//         $('#order_list_finished_button').click(function() {onOrderListFinished();});
//         $('#order_list_unfinished_button').click(function() {onOrderListUnfinished();});
// <<<<<<< HEAD
...
//         var data={};
// <<<<<<< HEAD
//         data.action="get_room_order_record";
//         data.id=id;
//         $.post("../../"+module+"_"+sub+"_room_order_servlet_action",data,function(json){
// =======
...
//             var id=getUrlParam("id");
// <<<<<<< HEAD
//             var url="../../homestay/servlet_room_order_servlet_action";
// =======
...
//         data = {};
// <<<<<<< HEAD
//         data.op_id=$("#record_query_setup #op_id").val();
...
//                         html=html+"                                        </td>";
// <<<<<<< HEAD
//                         html=html+"                                        <td><strong>"+record.op_id+"</strong></td>";
// =======
...
// <<<<<<< HEAD
//                         html=html+"                                                <a href=\"javascript:Page.onModifyRecord('"+record.op_id+"')\" class=\"btn btn-primary shadow btn-xs sharp me-1\"><i class=\"fas fa-pencil-alt\"></i></a>";
//                         html=html+"                                                <a href=\"javascript:Page.onDeleteRecord('"+record.op_id+"')\" class=\"btn btn-danger shadow btn-xs sharp\"><i class=\"fa fa-trash\"></i></a>";
// =======
...
//     }
// <<<<<<< HEAD
//     var onDeleteRecord = function(op_id){
//         if(confirm("您确定要删除这条订单记录吗？")){
//             var url="../../homestay_servlet_room_order_servlet_action";
//             var data={};
//             data.action="delete_room_order_record";
//             data.op_id=op_id;
...
//     };
//
//     var onModifyRecord=function(op_id){
//         //显示出修改前数据
//         //window.location.href="device_modify.jsp?op_id="+op_id;
//         $.post("../../"+module+"_"+sub+"_room_order_servlet_action?action=get_room_order_record",data,function(json){
//             console.log(JSON.stringify(json));
//             if(json.result_code==0){
//                 var list=json.aaData;
...
//                 for(var i=0;i<list.length;i++)
//                 {
//                     if(list[i].op_id==op_id){
//                         $("#record_modify_div #op_id").val(list[i].op_id);
...
//         //     if(resultList[i].op_id==op_id){
//         //         $("#record_modify_div #op_id").val(resultList[i].op_id);
...
// <<<<<<< HEAD
//         jump_form.action="../../homestay/servlet_room_order_servlet_action?action=upload_file&device_id="+deviceId+"&device_name="+deviceName;
// =======
...
// <<<<<<< HEAD
//             url : '../../homestay/servlet_room_order_servlet_action?action=upload_file&device_id='+deviceId+"&device_name="+deviceName, /*设置post提交到的页面*/
// =======
...
//                         html=html+"                                        </td>";
//                         html=html+"                                        <td>";
//                         html=html+"                                            <a href=\"javascript:Page.onPayOrder('"+record.op_id+"')\">【支付订单】</a>";
// =======
//                         html=html+"                                                <a href=\"#\" class=\"btn btn-primary shadow btn-xs sharp me-1\"><i class=\"fas fa-pencil-alt\"></i></a>";
//                         html=html+"                                                <a href=\"javascript:Page.onDeleteRecord('"+record.order_id+"')\" class=\"btn btn-danger shadow btn-xs sharp\"><i class=\"fa fa-trash\"></i></a>";
//                         html=html+"                                            </div>";
...
//             var data={};
//             data.action="modify_device_record";
//             data.op_id=$("#record_modify_div #op_id").val();
...
// <<<<<<< HEAD
//         var url="../../homestay_servlet_room_order_servlet_action";
//         var data={"action":"get_room_order_record"};
//         data.username=user;
// =======
//         var url="../../homestay_servlet_specialty_order_servlet_action";
...
// <<<<<<< HEAD
//                         html=html+"                            lang=EN-US>"+record.op_id+"</span></b></p>";
// =======
...
// <<<<<<< HEAD
//         var url="../../homestay_servlet_room_order_servlet_action";
//         var data={"action":"get_room_order_record_by_hour"};
//         data.username=user;
// =======
//         var url="../../homestay/servlet_specialty_order_servlet_action";
