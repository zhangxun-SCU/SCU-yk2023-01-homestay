            ...
            <ul class="metismenu" id="menu">
                <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="../assets/wallet-page.html">My Wallet</a></li>
                        <li><a href="../assets/invoices.html">Invoices</a></li>
                        <li><a href="../assets/create-invoices.html">Create Invoices</a></li>
                        <li><a href="../assets/card-center.html">Card-Center</a></li>
                        <li><a href="../assets/transaction-details.html">Transaction</a></li>
                    </ul>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <button type="button" class="btn default blue-stripe" id="statistics_button"
