                                ...
                                <div class="card-body">
                                    <div class="profile-interest">
                                        ...
                                        <div class="row mt-4 sp4" id="lightgallery">
                                            <a href="../assets/images/profile/2.jpg"
                                               data-exthumbimage="../assets/images/profile/2.jpg"
                                               data-src="../assets/images/profile/2.jpg"
                                               class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                                <img src="../assets/images/profile/2.jpg" alt="" class="img-fluid">
                                            </a>
                                            <a href="../assets/images/profile/3.jpg"
                                               data-exthumbimage="../assets/images/profile/3.jpg"
                                               data-src="../assets/images/profile/3.jpg"
                                               class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                                <img src="../assets/images/profile/3.jpg" alt="" class="img-fluid">
                                            </a>
                                            <a href="../assets/images/profile/4.jpg"
                                               data-exthumbimage="../assets/images/profile/4.jpg"
                                ...
                                <div class="card-body">
                                    <div class="profile-news">
                                        ...
                                        <div class="media pt-3 pb-3">
                                            <img src="../assets/images/profile/5.jpg" alt="image" class="me-3 rounded"
                                                 width="75">
                                            <div class="media-body">
                                        ...
                                        <div class="media pt-3 pb-3">
                                            <img src="../assets/images/profile/6.jpg" alt="image" class="me-3 rounded"
                                                 width="75">
                                            <div class="media-body">
                                                <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection
                                                    of textile samples</a></h5>
                                        ...
                                        <div class="media pt-3 pb-3">
                                            <img src="../assets/images/profile/7.jpg" alt="image" class="me-3 rounded"
                                                 width="75">
                                            <div class="media-body">
                                                <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection
                                                    of textile samples</a></h5>
