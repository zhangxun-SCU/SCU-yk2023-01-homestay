...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="../assets/image/png" href="../assets/../assets/images/favicon.png" />
                            ...
                            <ul class="contacts">
                                ...
                                <li class="active dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="../assets/../assets/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="../assets/../assets/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="../assets/../assets/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
                                            <span class="online_icon"></span>
                                        </div>
                                        <div class="user_info">
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="../assets/../assets/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
                                            <span class="online_icon offline"></span>
                                        </div>
                                        <div class="user_info">
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="../assets/../assets/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
                                            <span class="online_icon offline"></span>
                                        </div>
                                        <div class="user_info">
                ...
                <div class="col-xl-6 col-xxl-12">
                    <div class="card">
                        <div class="card-header d-block">
                            <button type="button" class="btn btn-rounded btn-success" id="add_button" name="add_button">我要反馈</button>
                        </div>
                    </div>
                </div>
            </div>
